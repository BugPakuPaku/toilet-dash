  ...
  return (
    <>
      <Box sx={{ display: { xs: 'block', md: 'none' } }}>
        <SPMapComponent />
        <span className="absolute z-[1] top-[20px] right-0 bg-white rounded-[2px] shadow-md m-[10px]">
          <Link href={`/list`}><Image className="p-[5px] aspect-square" width={40} height={40} style={{ objectFit: "contain" }} src="/menu.svg" alt="menu" /></Link>
        </span>
      </Box>
